...
public class P_GameController : MonoBehaviour
{
    ...
    public int[] N_Color = new int[2];//生成時の色
    public int[] Color = new int[2];//生成時の色
        ...
        for (int i = 0; i < 12; i++)
        {
            for(int j = 0; j < 6; j++)
            {
                ...
                if (Search[x, y] == false && Puyo_Data[x, y] != 'N')
                {
                    ...
                    //Debug.Log($"2段目{pro_Puyo_Delete[0, 1]}{pro_Puyo_Delete[1, 1]}{pro_Puyo_Delete[2, 1]}{pro_Puyo_Delete[3, 1]}{pro_Puyo_Delete[4, 1]}{pro_Puyo_Delete[5, 1]}");
                    //Debug.Log($"1段目{pro_Puyo_Delete[0, 0]}{pro_Puyo_Delete[1, 0]}{pro_Puyo_Delete[2, 0]}{pro_Puyo_Delete[3, 0]}{pro_Puyo_Delete[4, 0]}{pro_Puyo_Delete[5, 0]}");
                    for (int a = 0; a < 72; a++)
                    {
